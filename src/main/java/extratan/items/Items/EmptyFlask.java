...
public class EmptyFlask extends BaseItem {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (blockTemp < 0.2f)
			newstack = new ItemStack(Item.getByNameOrId("extratan:flask_with_cold_water"));
		else if (blockTemp > 0.85f)
			newstack = new ItemStack(Item.getByNameOrId("extratan:flask_with_hot_water"));
		else
			newstack = new ItemStack(Item.getByNameOrId("extratan:filled_flask"));
